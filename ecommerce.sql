...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : dim. 27 avr. 2025 à 09:29
...
(4, 4, '2025-04-26 14:47:23', 9.00, '8', 'terminee'),
(5, 4, '2025-04-26 16:04:47', 100.00, '9', 'terminee');
...
(5, 'Samba', 100.00, 199, 5, 'C:\\Users\\elsab\\OneDrive\\Bureau\\ING3\\POO Java\\photos_produitsShop\\Capture d\'écran 2025-04-20 111050.png', 'Adidas', 'Quand les plus grands titres sont en jeu, on peut compter sur Lionel Messi pour être performant. Représente la passion de l\'Argentine sur le terrain et en dehors avec cette chaussure de football adidas Samba junior confortable. Ornée de détails du joueur, cette chaussure classique à 3 bandes présente une tige en cuir signature et une semelle extérieure en caoutchouc adhérent.', 1, 3, 250),
(7, 'Café', 9.00, 299, 5, 'C:\\Users\\elsab\\Downloads\\café.png', 'Carte noir', 'Prêt à faire voyager vos papilles ? Éthiopie, Honduras, Colombie... On a exploré le monde et on en a rapporté les meilleurs grains. Chacun a dû faire ses preuves pour entrer dans la composition de nos cafés : dimensions, origine, profil aromatique… Chez nous, on ne plaisante pas avec le goût !', 1, 2, 15),
(8, 'Rouge à lèvres', 50.00, 538, 5, 'C:\\Users\\elsab\\OneDrive\\Bureau\\ING3\\POO Java\\photos_produitsShop\\ral_dior.jpg', 'Dior', 'Un rouge à lèvres toujours plus couture qui procure longue tenue et 24 h* de confort, le tout dans une formule clean** et infusée de soin floral hydratant.', 0, 0, 0),
(10, 'mascara', 30.00, 210, 5, 'C:\\Users\\elsab\\OneDrive\\Bureau\\ING3\\POO Java\\photos_produitsShop\\mascara.jpg', 'Dior', 'Ce mascara habille le regard d\'un volume cil à cil parfaitement défini. Infusée en extrait de fleur de bleuet, sa formule est facile à travailler et ne transige pas sur la performance.', 1, 10, 280),
